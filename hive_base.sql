...
!echo 'completed geo_cleaned' ;

drop table dist_county_map;
create external table dist_county_map
(
county string,
district string,
concern string
...
STORED AS TEXTFILE
LOCATION '/user/w205/tn_d4d/dist_county_map';

!echo 'completed county_map' ;
